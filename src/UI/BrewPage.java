		...
		btnCan.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(cBatch.equals("")) {
					...
					JOptionPane.showMessageDialog(null,"Please input batch size!(*^¨Œ^*)","Warning",JOptionPane.ERROR_MESSAGE);
					//Refresh this page
					closeThis();
					...
					try {
						...
						if(batch < 0) {
							...
							JOptionPane.showMessageDialog(null,"Please input a positive number!<(*T¨ŒT*)>","Warning",JOptionPane.ERROR_MESSAGE);
